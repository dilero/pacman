...
import pacman.controllers.me.montecarlo.DilerExecutor;
import pacman.controllers.me.montecarlo.DilerMonteCarloPacMan;
import pacman.controllers.me.montecarlo.DilerMonteCarloSimulation;
import pacman.controllers.me.montecarlo.DilerPacMan;
...
{	
	...
	public static void main(String[] args)
	{
		...
		//DilerMonteCarloSimulation simulation = new DilerMonteCarloSimulation(new Game(rnd.nextLong()), 975, 10);
	...
	//	exec.runGameTimed(new NearestPillPacMan(),new AggressiveGhosts(),visual);
		...
		//exec.runGameTimed(new RandomPacMan(),new StarterGhosts(),visual);
	//	exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);	
		...
		*/
		...
		boolean visual=true;
		exec.runGame(new DilerPacMan(),new StarterGhosts(),visual, 50);
		//exec.runGameTimed(new HumanController(new KeyBoardInput()),new Legacy(),visual);	
		//exec.runGameTimed(new DilerPacMan(),new StarterGhosts(),visual);
		//exec.runExperiment(new DilerPacMan(), new Legacy(), 100);
		//exec.runExperiment(new DilerPacMan(), new StarterGhosts(), 100);
	}
    ...
    public void runExperiment(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
    {
		...
		System.out.println("Maxiumum Score " + maxScore );
    }
	...
	public void runGame(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,boolean visual,int delay)
	{
		...
		if(visual) {
			...
			gv.getFrame().addKeyListener(input);
